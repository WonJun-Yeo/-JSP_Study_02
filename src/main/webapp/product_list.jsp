...
<BODY>
	...
	<P align=center>
		<FONT color=#0000ff face=굴림 size=+1> <STRONG> 상품 목록 </STRONG></FONT>
	</P>

	<FORM method=post name=search action="product_list.jsp">
		<TABLE border=0 width=95%>
			<TR>
				<TD align=right><FONT size=-1>상품명으로 찾기</FONT> <INPUT type=text
					name=pname> <INPUT type=submit value="검색"></TD>
			</TR>
			<TR>
				<TH><FONT size=-1> [<A href="main.htm">메인으로</A>] <A
						href="product_list.jsp">전체</A>- <A href="product_list.jsp?cat=11">가구</A>-
						<A href="product_list.jsp?cat=22">전기/전자</A>- <A
						href="product_list.jsp?cat=33">부엌용품</A>- <A
						href="product_list.jsp?cat=44">의류</A>- <A
						href="product_list.jsp?cat=55">보석 및 악세사리</A>- <A
						href="product_list.jsp?cat=66">헬스 기구</A>- <A
						href="product_list.jsp?cat=77">컴퓨터 관련</A>- <A
						href="product_list.jsp?cat=88">기타</A>
				</FONT></TH>
			</TR>
		</TABLE>
	</FORM>
	...
	<CENTER>
		<TABLE border=0 width=95% cellpadding=4 cellspacing=4
			style="font-size: 10pt">
			<TR>
				<TH width=5% bgcolor=#DFEDFF><FONT color=black face=굴림>
						<NOBR>번호</NOBR>
				</FONT></TH>
				<TH width=25% bgcolor=#DFEDFF><FONT color=black face=굴림>
						<NOBR>상품명</NOBR>
				</FONT></TH>
				<TH width=10% bgcolor=#DFEDFF><FONT color=black face=굴림>
						<NOBR>코드번호</NOBR>
				</FONT></TH>
				<TH width=15% bgcolor=#DFEDFF><FONT color=black face=굴림>
						<NOBR>제조원</NOBR>
				</FONT></TH>
				<TH width=10% bgcolor=#DFEDFF><FONT color=black face=굴림>
						<NOBR>판매시작일</NOBR>
